---
title: CVPR2022论文梳理
description: 主要收集多模态内容生成方面论文,以及人脸生成和反欺骗论文
...
3. L-Verse: Bidirectional Generation Between Image and Text（L-Verse:图像文本间的双向生成）[paper](https://arxiv.org/abs/2111.11133)
...
4. Conditional Prompt Learning for Vision-Language Models（视觉-语言模型的条件提示学习）[paper](https://arxiv.org/abs/2203.05557)
...
5. CLIP-NeRF: Text-and-Image Driven Manipulation of Neural Radiance Fields（CLIP-NeRF:文本和图像驱动的神经辐射场操作）[paper](https://arxiv.org/abs/2112.05139)
...
6.  Pseudo-Q: Generating Pseudo Language Queries for Visual Grounding（Pseudo-Q:为视觉基础生成伪语言查询）[paper](https://arxiv.org/abs/2203.08481)
...
7. NLX-GPT: A Model for Natural Language Explanations in Vision and Vision-Language Tasks（NLX-GPT:视觉和视觉-语言任务中的自然语言解释模型）[paper](https://arxiv.org/abs/2203.05081)
...
8. HairCLIP: Design Your Hair by Text and Reference Image（HairCLIP:通过文本和参考图像设计你的头发）[paper](https://arxiv.org/abs/2112.05142)
...
9. Vision-Language Pre-Training with Triple Contrastive Learning（三重对比学习的视觉语言预训练）[paper](https://arxiv.org/abs/2202.10401)
...
10. FENeRF: Face Editing in Neural Radiance Fields（FENeRF:神经辐射场中的人脸编辑）[paper](https://arxiv.org/abs/2111.15490)
...
11. Domain Generalization via Shuffled Style Assembly for Face Anti-Spoofing（通过 Shuffled Style Assembly 进行人脸反欺骗的域泛化）[paper](https://arxiv.org/abs/2203.05340)
...
12. Self-supervised Learning of Adversarial Example: Towards Good Generalizations for Deepfake Detection（对抗样本的自监督学习：迈向 Deepfake 检测的良好泛化）[paper](https://arxiv.org/abs/2203.12208)
...
13. Attribute Group Editing for Reliable Few-shot Image Generation(属性组编辑用于可靠的小样本图像生成) [paper](https://arxiv.org/abs/2203.08422v1)
...
14. FLAG: Flow-based 3D Avatar Generation from Sparse Observations(从稀疏观察中生成基于流的 3D 头像)[paper](https://arxiv.org/abs/2203.05789v1)
...
15. Dynamic Dual-Output Diffusion Models(动态双输出扩散模型)[paper](https://arxiv.org/abs/2203.04304)

    *Yaniv Benny, Lior Wol* 
...
16. Sparse to Dense Dynamic 3D Facial Expression Generation(稀疏到密集的动态 3D 面部表情生成)[paper](https://arxiv.org/abs/2105.07463v1)
